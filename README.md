...
3. Experience AI workflow harness through CLI/dev commands.
4. TUI presentation once the workflow is stable.
5. Optional FastAPI interface later, using the same application services.
